...
def help():
     print('\n' + colors.yellow + 'U' + colors.normal
          ...
          + colors.blue + ':' + colors.normal + ' ./web_finder.py -u https://www.example.com\n')

     print(colors.red + '-u/--url ' + colors.normal  + colors.cyan + 'To enter an URL.' + colors.normal)
     print(colors.red + '-h/--help ' + colors.normal + colors.cyan + 'To see help.' + colors.normal)
     print('')
...
def email_find(url):
    ...
    #bool(emails_found)
    #if emails_found == False:
	#for email_found in emails_found:
	    #print(colors.red + '[+] ' + color.normal + color.green + 'Emails not founded...' + colors.normal)
	    #pass
        #pass
    #else:
        #for email_found in emails_found:
        ...
        try:
            while True:
                ...
                try:
                    ...
                    print(colors.red + '\nKeyboard Interreputed (CTRL+C) Exiting...' + colors.normal)
                    quit()

                html_link = req_links.text
                links = re.findall(r'<a href="?\'?(https?:\/\/[^"\'>]*)', html_link)
                print(colors.red + '[+] ' + colors.normal + colors.green + 'Link Founded: ' + colors.normal + colors.yellow + str(url_crawl) + colors.normal)
            ...
            print(colors.red + '\nKeyboard Interrupted (CTRL+C) Exiting...' + colors.normal)
            quit()
